class Board 
   ...
   def winning_vertical?
       ...
       verticalarray=[@board[@column.to_i][6],@board[@column.to_i][5],
       @board[@column.to_i][4],@board[@column.to_i][3],@board[@column.to_i][2],
       @board[@column.to_i][1],@board[@column.to_i][0]]
   ...
   def winning_diagonal?
   		#red is one diagonal, green is another
   		#red
		...
		d4= [@board[0][1],@board[1][2],@board[2][3],@board[3][4],@board[4][5],@board[5][6]]
   		...
   		d9=[@board][5][0],@board][4][1],@board][3][2],@board][2][3],@board][1][4],
        @board][0][5]] 
